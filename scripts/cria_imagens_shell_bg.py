...
# Pastas e arquivo
datasetHsRegional = Dataset(resultsDir + simulationName + '/bg/ww3.' + startingDate[0:6] + '_hs.nc')
datasetDirRegional = Dataset(resultsDir + simulationName + '/bg/ww3.' + startingDate[0:6] + '_dir.nc')
pathSaveRegional = (resultsDir + simulationName + '/bg/imagens')
