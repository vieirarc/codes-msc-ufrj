...
for i in filenamesList:
	...
	# get time variable from ww3 HS result *** time variable is the same *** 
	energyTranspWw3 = Dataset('/home/piatam8/ww3/ww3_shell/modelo_hindcast/resultados/teste_1/bg/ww3.' + i[5:12] + 'hs.nc') 
	tempo = energyTranspWw3['time']
