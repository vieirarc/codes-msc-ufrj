...
pathSave = '/home/piatam8/ww3/ww3_shell/modelo_hindcast/resultados/' + simulationName + '/swan-BG/imagens/simulacao_geral/validacao/RJ-3/tp'
...
ax = plt.subplot()
ax.grid(True)
ax.set_title(u'Time Series Tp - RJ-3 Buoy - Summer 2017', fontsize=20)
font = {'size':16}
...
ax = plt.subplot()
ax.grid(True)
ax.set_title(u'Time Series Tp - RJ-3 Buoy - Autumn 2017', fontsize=20)
font = {'size':16}
locator = mdates.HourLocator(interval=72)  # every month
dfmt = mdates.DateFormatter('%d%b')
...
ax = plt.subplot()
ax.grid(True)
ax.set_title(u'Time Series Tp - RJ-3 Buoy - Winter 2017', fontsize=20)
font = {'size':16}
locator = mdates.HourLocator(interval=72)  # every month
dfmt = mdates.DateFormatter('%d%b')
...
ax = plt.subplot()
ax.grid(True)
ax.set_title(u'Time Series Tp - RJ-3 Buoy - Spring 2017', fontsize=20)
font = {'size':16}
locator = mdates.HourLocator(interval=72)  # every month
dfmt = mdates.DateFormatter('%d%b')
...
ax = plt.subplot()
ax.grid(True)
ax.set_title(u'Time Series Tp - RJ-3 Buoy - Summer 2018', fontsize=20)
font = {'size':16}
locator = mdates.HourLocator(interval=72)  # every month
dfmt = mdates.DateFormatter('%d%b')
...
ax = plt.subplot()
ax.grid(True)
ax.set_title(u'Time Series Tp - RJ-3 Buoy - Autumn 2018', fontsize=20)
font = {'size':16}
locator = mdates.HourLocator(interval=72)  # every month
dfmt = mdates.DateFormatter('%d%b')
...
ax = plt.subplot()
ax.grid(True)
ax.set_title(u'Time Series Tp - RJ-3 Buoy - Winter 2018', fontsize=20)
font = {'size':16}
locator = mdates.HourLocator(interval=72)  # every month
dfmt = mdates.DateFormatter('%d%b')
...
ax = plt.subplot()
ax.grid(True)
ax.set_title(u'Time Series Tp - RJ-3 Buoy - Spring 2018', fontsize=20)
font = {'size':16}
locator = mdates.HourLocator(interval=72)  # every month
dfmt = mdates.DateFormatter('%d%b')
