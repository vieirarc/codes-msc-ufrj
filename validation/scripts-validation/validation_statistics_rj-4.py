...
# creating table
f = open('/home/piatam8/ww3/ww3_shell/modelo_hindcast/resultados/' + simulationName + '/swan-BG/imagens/simulacao_geral/validacao/RJ-4/statistics_table/statistics_table_RJ-4_buoy.txt', "w")
...
f.write('\n')
f.write('Mean Hs Buoy: ' + str(Rj4HsXm))
f.write('\n')
f.write('Mean Hs SWAN: ' + str(SwanHsYm))
f.write('\n')
f.write('__________________________________________________')
f.write('\n')
f.write('Mean Tp Buoy: ' + str(Rj4TpXm))
f.write('\n')
f.write('Mean Tp SWAN: ' + str(SwanTpYm))
f.write('\n')
f.write('__________________________________________________')
f.write('\n')
f.write('Bias Hs: ' + str(biasHs))
f.write('\n')
f.write('Bias Tp: ' + str(biasTp))
f.write('\n')
f.write('__________________________________________________')
f.write('\n')
f.write('RMSE Hs: ' + str(RMSE_Hs))
f.write('\n')
f.write('RMSE Tp: ' + str(RMSE_Tp))
f.write('\n')
f.write('__________________________________________________')
f.write('\n')
f.write('SI Hs - Scatter Index: ' + str(SI_Hs))
f.write('\n')
f.write('SI Tp - Scatter Index: ' + str(SI_Tp))
f.write('\n')
f.write('__________________________________________________')
f.write('\n')
f.write('Sym r Hs - Symmetric Slope: ' + str(symR_Hs))
f.write('\n')
f.write('Sym r Tp - Symmetric Slope: ' + str(symR_Tp))
f.write('\n')
f.write('__________________________________________________')
f.write('\n')
f.write('Corr Hs - Correlation Coefficient: ' + str(corrHs))
f.write('\n')
f.write('Corr Tp - Correlation Coefficient: ' + str(corrTp))
f.write('\n')
f.write('__________________________________________________')
f.close()
